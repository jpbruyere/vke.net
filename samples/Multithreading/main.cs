...
namespace Multithreading {
	...
	class Program : SampleBase {
		...
		public GraphicPipeline shapePipeline;
		...
		protected override void initVulkan () {
			...
			using (GraphicPipelineConfig cfg = GraphicPipelineConfig.CreateDefault (VkPrimitiveTopology.TriangleList, VkSampleCountFlags.SampleCount4)) {
				...
				cfg.AddShader (dev, VkShaderStageFlags.Vertex, "#shaders.texture.vert.spv");
				cfg.AddShader (dev, VkShaderStageFlags.Fragment, "#shaders.texture.frag.spv");
			...
			using (GraphicPipelineConfig cfg = GraphicPipelineConfig.CreateDefault (VkPrimitiveTopology.TriangleList, VkSampleCountFlags.SampleCount1, false)) {
				...
				cfg.RenderPass = new RenderPass (dev, threadedCommands.imgFormat, cfg.Samples);
				...
				shapePipeline = new GraphicPipeline (cfg);
			}
